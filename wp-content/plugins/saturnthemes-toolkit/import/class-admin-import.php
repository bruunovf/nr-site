...
class SaturnThemes_Abbey_Admin_Import {
	...
	public function __construct() {
		...
		add_filter( 'saturnthemes_admin_menus', array( $this, 'menu_import' ) );
	...
	public function enqueue_scripts( $hook ) {
		...
		if ( 'appearance_page_' . SaturnThemes_THEME_PREFIX . 'import' != $hook ) {
			return;
		}
	...
	public function menu_import( $menus ) {
		$menus[] = array(
			...
			'page_title' => sprintf( __( '%s Import', 'saturnthemes-abbey' ), SaturnThemes_THEME ),
			'menu_title' => sprintf( __( '%s Import', 'saturnthemes-abbey' ), SaturnThemes_THEME ),
			'menu_slug'  => SaturnThemes_THEME_PREFIX . 'import',
