jQuery(document).ready(function($){
  ...
  function custom_title_style () {
    var value = $("#saturnthemes_industry_title_style").val();
    switch(value) {
      case "bg_color":
  ...
  if(!$("#saturnthemes_industry_enable_title").prop("checked")) {
  ...
  $("#saturnthemes_industry_enable_title").change(function(){
    if($("#saturnthemes_industry_enable_title").prop("checked")) {
  ...
  $("#saturnthemes_industry_title_style").change(function(){
    var value = $(this).val();
    switch(value) {
      case "bg_color":
        $(".cmb2-id-saturnthemes-heading-image").slideUp();
