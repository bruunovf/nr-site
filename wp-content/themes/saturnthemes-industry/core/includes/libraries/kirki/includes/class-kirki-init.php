...
class Kirki_Init {
	...
	public function set_url() {
		...
		if ( Kirki_Toolkit::is_parent_theme( __FILE__ ) ) {
			Kirki::$url = trailingslashit( get_template_directory_uri() . '/core/includes/libraries/kirki/' );
		}
		/**
		 * Are we on a child theme?
		 */
		elseif ( Kirki_Toolkit::is_child_theme( __FILE__ ) ) {
			Kirki::$url = trailingslashit( get_stylesheet_directory_uri() . '/core/includes/libraries/kirki/' );
		}
		/**
		 * Fallback to plugin
		 */
