...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" style="background-color: <?php echo esc_attr( $box_bg_color ); ?>;">
	...
	<span class="icon-box-icon" style="background-color: <?php echo esc_attr( $icon_background_color ); ?>;">
	...
	<div class="icon-box-content">
		...
		<?php if ( $content ) : ?>
			<div class="icon-box-desc" style="color: <?php echo esc_attr( $content_color ) ?>;"><?php echo '' . $content; ?></div>
		<?php endif; ?>
