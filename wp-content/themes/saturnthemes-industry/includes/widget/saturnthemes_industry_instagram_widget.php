<?php
if ( ! class_exists( 'saturnthemes_industry_Instagram_Widget' ) ) {

    add_action( 'widgets_init', 'load_saturnthemes_instagram_widget' );

    function load_saturnthemes_instagram_widget() {
        register_widget( 'saturnthemes_industry_Instagram_Widget' );
    }

    /**
     * Instagram Widget
     */
    class saturnthemes_industry_Instagram_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                'saturnthemes_instagram',
                esc_html__( 'SaturnThemes - Instagram', 'saturnthemes-industry' ),
                array( 'description' => esc_html__( 'Displays latest Instagram photos', 'saturnthemes-industry' ) )
            );
        }
        ...
        function widget( $args, $instance ) {
            ...
            $follow_text         = isset( $instance[ 'follow_text' ] ) ? $instance[ 'follow_text' ] : esc_html__( 'Follow us on Instagram', 'saturnthemes-industry' );
        ...
        function form( $instance ) {
            ...
            $show_likes_comments = isset( $instance[ 'show_likes_comments' ] ) ? $instance[ 'show_likes_comments' ] : '';
            $show_follow_text    = isset( $instance[ 'show_follow_text' ] ) ? $instance[ 'show_follow_text' ] : '';
            $follow_text         = isset( $instance[ 'follow_text' ] ) ? $instance[ 'follow_text' ] : esc_html__( 'Follow Us', 'saturnthemes-industry' );
            $link_new_page       = isset( $instance[ 'link_new_page' ] ) ? $instance[ 'link_new_page' ] : '';
            ...
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'User Name', 'saturnthemes-industry' ) ?></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'number_items' ) ); ?>"><?php esc_html_e( 'Number of items', 'saturnthemes-industry' ) ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'show_likes_comments' ) ); ?>"><?php esc_html_e( 'Show likes and comments', 'saturnthemes-industry' ) ?></label>
            </p>
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'show_follow_text' ) ); ?>"><?php esc_html_e( 'Show follow text', 'saturnthemes-industry' ) ?></label>
            </p>
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'follow_text' ) ); ?>"><?php esc_html_e( 'Text', 'saturnthemes-industry' ) ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'link_new_page' ) ); ?>"><?php esc_html_e( 'Open links in new page:', 'saturnthemes-industry' ) ?></label>
            </p>
            <strong><?php esc_html_e( 'Responsiveness', 'saturnthemes-industry' ); ?></strong>
            <?php
        }
        ...
        public function scrape_instagram( $username, $slice ) {
            ...
            if ( false === ( $instagram = get_transient( 'instagram-media-new-' . sanitize_title_with_dashes( $username ) ) ) ) {
                ...
                if ( is_wp_error( $remote ) ) {
                    return new WP_Error( 'site_down', esc_html__( 'Unable to communicate with Instagram.', 'saturnthemes-industry' ) );
                }

                if ( 200 != wp_remote_retrieve_response_code( $remote ) ) {
                    return new WP_Error( 'invalid_response', esc_html__( 'Instagram did not return a 200.', 'saturnthemes-industry' ) );
                }
                ...
                if ( ! $insta_array ) {
                    return new WP_Error( 'bad_json', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-industry' ) );
                }
                ...
                if ( isset( $insta_array[ 'entry_data' ][ 'UserProfile' ][ 0 ][ 'userMedia' ] ) ) {
                    ...
                    return new WP_Error( 'bad_josn_2', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-industry' ) );
                }

                if ( ! is_array( $media_arr ) ) {
                    return new WP_Error( 'bad_array', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-industry' ) );
                }
                ...
                switch ( $type ) {
                    ...
                    default:
                        foreach ( $media_arr as $media ) {
                            ...
                            $instagram[] = array(
                                'description' => esc_html__( 'Instagram Image', 'saturnthemes-industry' ),
                ...
                if ( ! empty( $instagram ) ) {
                    $instagram = saturnthemes_bb_en( serialize( $instagram ) );
            ...
            if ( ! empty( $instagram ) ) {
                ...
                $instagram = unserialize( saturnthemes_bb_de( $instagram ) );

                return array_slice( $instagram, 0, $slice );;

            } else {

                return new WP_Error( 'no_images', esc_html__( 'Instagram did not return any images.', 'saturnthemes-industry' ) );
