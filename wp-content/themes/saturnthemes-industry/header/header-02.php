...
<header id="header" class="header header-layout-2 <?php echo esc_attr( $saturnthemes_industry_header_type ); echo esc_attr( saturnthemes_industry_get_overlay_header() ? 'header-overlay' : '' ); ?>">
                        ...
                        <?php foreach ( (array)Kirki::get_option( 'saturnthemes', 'header_contact_details' ) as $saturnthemes_financebank_header_contact ) : ?>
                            <li>
                                <div class="header-contact-detail">
                                    <span class="header-contact-detail-icon"><i class="fa <?php echo esc_attr( $saturnthemes_financebank_header_contact['icon'] ); ?>"></i></span>
                                    <div class="header-contact-detail-info">
                                        <div class="header-contact-detail-title"><?php echo html_entity_decode( $saturnthemes_financebank_header_contact['title'] ); ?></div>
                                        <a class="header-contact-detail-extra-info" <?php if ( $saturnthemes_financebank_header_contact['url'] ) : ?> href="<?php esc_url( $saturnthemes_financebank_header_contact['url'] ); ?>" <?php endif; ?>>
                                            <?php echo html_entity_decode( $saturnthemes_financebank_header_contact['information'] ); ?>
                                        </a>
                                    </div>
                                </div>
                            </li>
    ...
    <div class="header-nav hidden-md-down <?php echo esc_attr( Kirki::get_option( 'saturnthemes', 'header_sticky_enable' ) != 1 ? 'affix-disabled' : ''  ); ?>" data-spy="affix" data-offset-top="180">
        <div class="container">
            <div class="row row-xs-center">
                <div class="col-md-11">
